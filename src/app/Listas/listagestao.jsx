                ...
                const filtered = await Promise.all(
                    props.arrayClientes.map(async (cliente) => {
                        try {
                            ...
                            const allNames = ((cliente.cobrador === "bruno") || (cliente.cobrador === "allan") || (cliente.cobrador === "jhow") || (cliente.cobrador === "ana") || (cliente.cobrador === "karol") || (cliente.cobrador === "talita") );
                            if ((allNames && allVisu) ||
