    ...
    return (
        <div>
            ...
            <div className="voltar row">
                ...
                <Link to="/app/cobrancamapsempresas" onClick={handleOnClick} type="button" className="btn btn-primary btn-acao">Salvar</Link>
            </div>
        </div>
    );
}

export default FichaAlterar;